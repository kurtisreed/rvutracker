...
// Query for this year
$sql_this_year = "SELECT DATE(`date`) as entry_date, COUNT(*) as entry_count
                  FROM mohsdata
...
// Query for last year
$sql_last_year = "SELECT DATE(`date`) as entry_date, COUNT(*) as entry_count
                  FROM mohsdata
...
if ($result_last_year->num_rows > 0) {
    ...
    header('Content-Type: application/json');
    echo json_encode(['error' => 'Unable to fetch cumulative Mohs data']);
